...
func TestCategorize1(t *testing.T) {
	transactions := []dbPkg.Transaction{
		{Description: "groceriesT A W A WAHANUI", CategoryID: 0, Amount: -1},
		{Description: "920023 Weekly Rent", CategoryID: 1, Amount: -1},
	}
	toClassify := []dbPkg.Transaction{
		{Description: "groceriesT A W A WAHANUI", CategoryID: -1, Amount: -1},
	}
